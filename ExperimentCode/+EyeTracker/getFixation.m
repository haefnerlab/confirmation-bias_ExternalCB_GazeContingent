function [is_holding, tracker_info, coordinates_history] = getFixation(tracker_info, xc,yc, wPtr, background)
...
while GetSecs() - start < tracker_info.fixationTime / 1000
    ...
    EyeTracker.drawFixationSymbol(tracker_info, xc,yc, wPtr);
