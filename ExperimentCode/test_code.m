...
thresh = 0.8;
proto_exp = newGaborData('trials_per_block',50,'contrast',con,'blocks',10,'number_of_images', num_im, 'no_staircase',1,'ratio', ratio, 'eyelink_use', track_eye, 'noise', thresh);
