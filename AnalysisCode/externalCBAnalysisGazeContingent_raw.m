function [belief_opp_cases] = externalCBAnalysisGazeContingent_raw(chosen_signals,not_chosen_signals,gaps, num_peri, boot_n)
...
for i=1:num_trials
    ...
    for j=1:num_saccade % evidence guiding saccade is collected till max saccade - 1
        info_per_saccade(i,j) = acc_belief + chosen_signals(i,j) ;% evidence collected so far
