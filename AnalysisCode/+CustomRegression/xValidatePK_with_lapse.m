function [best_hprs, log_likelihoods] = xValidatePK_with_lapse(data, responses, frames, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds, opt_type)
...
%         hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0);
    [params, ~, ~, ~, ~, ~] = ...
     CustomRegression.PsychophysicalKernelwithlapse(data(dataIdx, :), responses(dataIdx), frames,  ...
        hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0, opt_type);
