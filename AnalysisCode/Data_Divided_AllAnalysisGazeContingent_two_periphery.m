% function [belief_opp_cases, trials_opp,belief_opp_cases_fixed, trials_opp_fixed,not_wt_belief_opp_cases_fixed, not_wt_trials_opp_fixed, num_sessions, num_trials_per_session] = Data_Divided_AllAnalysisGazeContingent_two_periphery(subjectID, phase, boot_n, gaps, params_boot_fixed, hpr1, hpr2)
function [belief_opp_cases, trials_opp, params_per_session,num_sessions, num_trials_per_session] = Data_Divided_AllAnalysisGazeContingent_two_periphery(subjectID, phase, boot_n, gaps, hpr1, hpr2)
