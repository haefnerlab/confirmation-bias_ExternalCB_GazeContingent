...
for tr=1:num_trials
    ...
    for i=1:num_frames-1
        ...
        % at each location)
        [BAS(tr,i,1),comp1(tr,i,1),comp2(tr,i,1)] = compute_score_vm(squeeze(table_ct_Il1_Il2_given_d(tr,:,:,:)),l1_dim_id,num_samples,is_sampling);
        [BAS(tr,i,2),comp1(tr,i,2),comp2(tr,i,2)] = compute_score_vm(squeeze(table_ct_Il1_Il2_given_d(tr,:,:,:)),l2_dim_id,num_samples,is_sampling);
